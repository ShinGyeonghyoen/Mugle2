...
# --- [4. 데이터 및 헬퍼 함수] ---
menu_pool = {
    "🥩 고기/정식": ["돈카츠 정식", "로스카츠", "히레카츠", "치킨난반", "쇼가야키", "함바그", "야키니쿠", "규카츠", "가라아게"],
    "🍜 면요리": ["쇼유 라멘", "돈코츠 라멘", "츠케멘", "아부라소바", "탄탄멘", "냉소바", "카레 우동"],
    "🍚 덮밥/카레": ["규동", "카츠동", "오야코동", "텐동", "사케동", "네기토로동", "비프 카레", "카츠 카레"],
    "🥢 중식/에스닉": ["마파두부", "호이코로", "에비칠리", "교자 세트", "카레", "가파오라이스", "팟타이"],
    "🥗 건강/가벼운": ["시저 샐러드", "두부 스테이크", "서브웨이", "포케 볼", "생선구이"],
    "🏪 편의점/로컬": ["로슨 카라아게", "세븐 나나치키", "패미마 치킨", "요시노야", "마츠야"]
}
