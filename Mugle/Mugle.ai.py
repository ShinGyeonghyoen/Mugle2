...
# --- [2. UI/UX 디자인: 파칭코 애니메이션 & 비디오 레이아웃] ---
st.markdown("""
    <style>
...
# --- [3. 설정 및 데이터베이스] ---
# ⚠️ 깃허브에 올린 파일의 Raw 주소로 교체하세요!
# 예: "https://raw.githubusercontent.com/ShinGyeonghyeon/Mugle2/main/dance.gif"
...
if st.session_state.app_state == "READY":
    if st.session_state.final_choice:
        ...
        st.markdown('<div class="ios-window"><div class="menu-display"><div class="menu-text" style="color:#8E8E93 !important;">📂 결재 서류 대기 중...</div></div></div>', unsafe_allow_html=True)
